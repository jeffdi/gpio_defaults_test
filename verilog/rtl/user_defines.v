...
`define USER_CONFIG_GPIO_16_INIT `GPIO_MODE_USER_STD_OUT_MONITORED
`define USER_CONFIG_GPIO_17_INIT `GPIO_MODE_USER_STD_ANALOG
`define USER_CONFIG_GPIO_18_INIT 13'h1555
`define USER_CONFIG_GPIO_19_INIT 13'h0aaa
`define USER_CONFIG_GPIO_20_INIT 13'h1333
`define USER_CONFIG_GPIO_21_INIT 13'h0ccc
`define USER_CONFIG_GPIO_22_INIT 13'h0f0f
`define USER_CONFIG_GPIO_23_INIT 13'h10f0
`define USER_CONFIG_GPIO_24_INIT 13'h1f00

`define USER_CONFIG_GPIO_25_INIT 13'h00ff
`define USER_CONFIG_GPIO_26_INIT 13'h0000
`define USER_CONFIG_GPIO_27_INIT 13'h1fff
`define USER_CONFIG_GPIO_28_INIT 13'h0ad2
`define USER_CONFIG_GPIO_29_INIT 13'h19e3
`define USER_CONFIG_GPIO_30_INIT 13'h08f4
`define USER_CONFIG_GPIO_31_INIT 13'h1705
`define USER_CONFIG_GPIO_32_INIT 13'h1606
`define USER_CONFIG_GPIO_33_INIT 13'h0507
`define USER_CONFIG_GPIO_34_INIT 13'h14f8
`define USER_CONFIG_GPIO_35_INIT 13'h13e9
`define USER_CONFIG_GPIO_36_INIT 13'h02ca
`define USER_CONFIG_GPIO_37_INIT 13'h01cb
